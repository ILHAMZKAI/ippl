...
@section('content')
    ...
    <main class="main-content">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-4 m-2 border-radius-lg"
            style="background-image: url('/img/bg109.jpg'); background-position: 70;">
                            ...
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="password" name="password_confirmation" class="form-control"
                                        placeholder="Konfirmasi Kata Sandi" aria-label="Confirm Password">
                                    @error('password')
                                        <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                    @enderror
                                </div>
                                <div class="form-check form-check-info text-start">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Saya menyetujui <a href="javascript:;" class="text-dark font-weight-bolder">Syarat
                                            dan Ketentuan</a>
                                    </label>
                                    @error('terms')
