    ...
    <div class="row mx-4 me-4-1 mb-4">
        <div class="col-12 mx-1">
            <div class="alert1 alert-light"><strong>Perkebunan</strong>
                @csrf
                <button class="btn btn-gm1 ms-3 mx-3 mt-n2" id="Infotools">Info</button>
        ...
        <div class="col-md-4">
            <div class="card px-8 mb-3">
                <div class="card-body mx-n8 mb-2">
                    <div class="form-group">
                        <label>1. Tambah lahan: berfungsi untuk menambahkan susunan lahan. </label>
                        <label>2. Ubah lahan: berfungsi untuk mengubah identitas lahan.</label>
                        <label>Lahan:</label>
                        <label>1. Pilih aksi: Digunakan untuk memilih aksi untuk timer</label>
                        <label>2. Tanggal & waktu: Digunakan untuk memilih jadwal akan dilaksanakan aksi</label>
                        <label>Warna merah menandakan jika lahan belum siap</label>
                        ...
                        <label>Alat:</label>
                        <label>1. Tandai lahan: Digunakan untuk menandai lokasi lahan</label>
                        <label>2. Tambah Berat: Digunakan untuk menambahkan detil penghasilan(kg) per area lahan</label>
                    </div>
                </div>
            </div>
        </div>
